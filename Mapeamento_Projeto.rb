puts'-' * 60
puts 'Mapeamento do Projeto'.center(60)
puts '-' * 60
...
# Escreva um programa Ruby calcula a área de um quadrado e um retângulo. Em cada um dos 
# casos, deve ser criado um módulo a parte, para que este seja executado de forma 
# independente de outro, ainda que ambos estejam no mesmo arquivo.
